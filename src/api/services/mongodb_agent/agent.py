...
class GPT5MongoDBAgent:
    """
    GPT-5.2 Reasoning Agent for MongoDB query generation and execution.

    Supports reasoning effort levels: minimal, low, medium, high, xhigh (new in 5.2)
    """

    # Valid reasoning effort levels for GPT-5.2
    ...
    def query(
        ...
        *,
        ...
        try:
            ...
            error_msg = f"GPT-5.2 Agent error: {exc}"
